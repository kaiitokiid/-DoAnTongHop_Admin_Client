...
function ProductList() {
    ...
    useEffect(() => {
        const url = `http://localhost:5000/api/products/for-admin?page=${param.page}&pageSize=${param.pageSize}&keyword=${param.keyword}&minPrice=${param.minPrice}&maxPrice=${param.maxPrice}&priceOrder=${param.priceOrder}&categoryId=${param.categoryId}&isLock=${param.isLock}`;
        var token = JSON.parse(localStorage.getItem('TOKEN'));
