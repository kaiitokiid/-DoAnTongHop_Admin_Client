...
function OrderList() {
    ...
    // get orders
    useEffect(() => {
        const url = `http://localhost:5000/api/orders/get-all-order?page=${param.page}&pageSize=${param.pageSize}&keyword=${param.keyword}&minPrice=${param.minPrice}&maxPrice=${param.maxPrice}&priceOrder=${param.priceOrder}&kindOfTransaction=${param.kindOfTransaction}&status=${param.status}`;
                ...
                <table id="customers">
                    <thead>
                        <tr>
                            ...
                            <th style={{width: "230px"}}>Tên cửa hàng</th>
